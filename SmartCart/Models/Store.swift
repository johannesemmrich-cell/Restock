    ...
    static func presets(for countryCode: String) -> [Store] {
        ...
        case "DE":
            return [
                ...
                Store(name: "Action",   emoji: "🏷️", colorHex: "#E53935", visitsPerWeek: 1, categories: Category.grocery,   countryCode: "DE"), // Rot
        ...
        case "AT":
            return [
                ...
                Store(name: "Action", emoji: "🏷️", colorHex: "#E53935", visitsPerWeek: 1, categories: Category.grocery,   countryCode: "AT"), // Rot
            ]
        case "CH":
            return [
        ...
        case "BE":
            return [
                ...
                Store(name: "Action",    emoji: "🏷️", colorHex: "#E53935", visitsPerWeek: 1, categories: Category.grocery,   countryCode: "BE"), // Rot
        ...
        case "NL":
            return [
                ...
                Store(name: "Action",       emoji: "🏷️", colorHex: "#E53935", visitsPerWeek: 1, categories: Category.grocery,   countryCode: "NL"), // Rot (niederländische Kette)
